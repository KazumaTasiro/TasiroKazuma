...
void FbxModel::CreateBuffers(ID3D12Device* device)
{
    ...
    CD3DX12_RESOURCE_DESC res = CD3DX12_RESOURCE_DESC::Buffer(sizeVB);
    ...
    CD3DX12_RESOURCE_DESC res2 = CD3DX12_RESOURCE_DESC::Buffer(sizeIB);
    // インデックスバッファ生成
    result = device->CreateCommittedResource(
        &heap2,
        D3D12_HEAP_FLAG_NONE,
    ...
    CD3DX12_HEAP_PROPERTIES heap3 = CD3DX12_HEAP_PROPERTIES(D3D12_CPU_PAGE_PROPERTY_WRITE_BACK, D3D12_MEMORY_POOL_L0);
    // テクスチャ用バッファの生成
    result = device->CreateCommittedResource(
        &heap3,
        D3D12_HEAP_FLAG_NONE,
